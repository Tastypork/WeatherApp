...
API_KEY = '689b735f618ab757e2f485d729550791'
...
cities = ["Atlanta", "Los Angeles", "Chicago", "Dallas", "Denver", "New York", "San Francisco", "Las Vegas", "Seattle", "Orlando", "Miami", "Charlotte", "Phoenix", "Houston", "Boston", "Minneapolis", "Detroit", "Philadelphia", "Salt Lake City", "San Diego", "Tampa", "Baltimore", "Portland", "St. Louis", "Nashville", "San Antonio", "Austin", "Cleveland", "Kansas City", "New Orleans", "Honolulu", "Indianapolis", "Pittsburgh", "Sacramento", "Cincinnati", "Raleigh", "Columbus", "Oakland", "Fort Myers", "San Jose", "Palm Springs", "Albuquerque", "Milwaukee", "West Palm Beach", "Burbank", "Boise", "Anchorage", "Spokane", "Reno", "Oklahoma City", "El Paso", "Richmond", "Tulsa", "Hartford", "Jacksonville", "Birmingham", "Guam", "San Juan", "Washington", "Kona", "St. Thomas", "Saipan", "Juneau", "Lihue"]
